"""
Django settings for almacen_main project.
...
SECRET_KEY = ')p70n8bhkws)i&^$q*qqcxr=q7(c_%3%3$2-o-ed(anonvhov5'
...
INSTALLED_APPS = [
    ...
    'translipsur_service_apps.auths',
    'translipsur_service_apps.auths_api',

    'translipsur_service_apps.repositorio',
    'translipsur_service_apps.repositorio_api',
...
ROOT_URLCONF = 'translipsur_main.urls'
...
WSGI_APPLICATION = 'translipsur_main.wsgi.application'
