...
//==================================
    ...
    .state('auths.hierarchy', {
     ...
     .state("auths.hierarchy.hierarchy_type", {
        ...
        templateUrl: "translipsur_web_apps/auths_web/views/hierarchy_type/index.html"
    })

    .state("auths.system.permission", {
        url: "/permission",
        data: { section: 'System', page: 'Permisos' },
        templateUrl: "translipsur_web_apps/auths_web/views/permission/index.html"
    })
    .state("auths.system.contenttype", {
        url: "/contenttype",
        data: { section: 'System', page: 'Aplicaciones' },
        templateUrl: "translipsur_web_apps/auths_web/views/contenttype/index.html"
    })

    .state("auths.system.log", {
        url: "/log",
        data: { section: 'System', page: 'Logs' },
        templateUrl: "translipsur_web_apps/auths_web/views/log/index.html"
    })
    ...
    .state("auths.system.menu", {
        ...
        templateUrl: "translipsur_web_apps/auths_web/views/menu/index.html",
